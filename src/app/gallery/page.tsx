  ...
  return (
    <>
      ...
      <main className="pt-[160px] pb-section-gap">
        {/* Header Section */}
        <header className="max-w-[1280px] mx-auto px-margin-desktop mb-section-gap text-center">
        ...
        {/* CTA Section */}
        <section className="mt-section-gap px-margin-desktop max-w-[1280px] mx-auto text-center">
